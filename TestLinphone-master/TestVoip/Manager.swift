...
//         idle()
    ...
    func makeCall(){
        let calleeAccount = "testgumi"

        guard let _ = setIdentify("edmund","sip.linphone.org") else {
            print("no identity")
            return
        }
    ...
    func receiveCall(){
        guard let proxyConfig = setIdentify("edmund","sip.linphone.org") else {
            print("no identity")
            return
        }
    ...
    func idle(){
        guard let proxyConfig = setIdentify("testgumi","sip.linphone.org") else {
            print("no identity")
            return
        }
        register(proxyConfig)
    ...
    func setIdentify(_ account: String, _ domain: String) -> OpaquePointer? {
        let account = account//"edmund" //// Put your account name here
        let domain = domain//"sip.linphone.org" //// Put your domain here
        let password = "19121996" //// Put your account password here
    ...
    fileprivate func setTimer(){
        AILinphoneManager.iterateTimer = Timer.scheduledTimer(
